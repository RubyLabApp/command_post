...
module CommandPost
  module Resources
    ...
    class DataTableComponent < ViewComponent::Base
      ...
      # @return [Array<CommandPost::Field>] Fields to show as columns
      attr_reader :fields
      ...
      # @param fields [Array<CommandPost::Field>] Fields
      ...
      # @api private
      # @return [Array<CommandPost::Field>] Fields visible to current user
      def visible_fields
