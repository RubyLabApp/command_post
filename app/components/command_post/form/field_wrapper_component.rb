...
module CommandPost
  module Form
    ...
    #   render CommandPost::Form::FieldWrapperComponent.new(name: :email, errors: @record.errors[:email]) do
    #     render CommandPost::Form::TextInputComponent.new(name: "record[email]")
    #   end
