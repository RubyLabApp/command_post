...
RSpec.describe CommandPost::FieldTypeRegistry do
  ...
  describe ".find" do
    it "returns the config for a registered type" do
      ...
      expect(config).to be_a(CommandPost::FieldTypeConfig)
    end
...
RSpec.describe CommandPost::FieldTypeConfig do
  describe "#render_display" do
    it "calls the display block" do
      ...
      field = CommandPost::Field.new(:rating, type: :star_rating)
