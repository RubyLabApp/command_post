...
require_relative "../../../../app/components/command_post/dashboards/activity_feed_component"

RSpec.describe CommandPost::Dashboards::ActivityFeedComponent, type: :component do
...
RSpec.describe CommandPost::Dashboards::ActivityFeedComponent::ItemComponent, type: :component do
  describe "#initialize" do
