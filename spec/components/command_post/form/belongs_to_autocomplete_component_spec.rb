...
require_relative "../../../../app/components/command_post/form/belongs_to_autocomplete_component"

RSpec.describe CommandPost::Form::BelongsToAutocompleteComponent, type: :component do
