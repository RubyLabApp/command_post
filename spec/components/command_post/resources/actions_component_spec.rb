...
require_relative "../../../../app/components/command_post/resources/actions_component"

RSpec.describe CommandPost::Resources::ActionsComponent, type: :component do
  before do
  ...
  describe "#initialize" do
    it "stores actions" do
      component = described_class.new(actions: actions, record: user, resource_class: UserResource)
  ...
  describe "#render?" do
    ...
    it "returns false when actions are empty" do
      component = described_class.new(actions: [], record: user, resource_class: UserResource)
